...
export const projects = [
  ...
  },
  {
    ...
    fullDescription:
      'Con el condicionante de una superficie en planta baja limitada según reglamento, la casa G y G concentra en una sola planta un programa bastante amplio si tenemos en cuenta sus 4 dormitorios, dos de los cuáles se organizan en suite, y a su cocina con isla que complementa un comedor principal y una galería. El ambiente público restante, el estar, se comunica con el exterior a través de un gran ventanal en altura, ya que tanto éste ambiente cómo el comedor comparten la gran espacialidad que les da sus 3.70 m de altura.',
    featured: false,
